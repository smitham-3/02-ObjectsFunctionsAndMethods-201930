...
def main():
    ...
    #even_better_draw_circles(rg.Point(100, 50), 10, 5, 'red', 10)
    #even_better_draw_circles(rg.Point(-200, 0), 25, 20, 'green', 20)
    even_better_draw_circles(rg.Point(50, 0), 5, 9, 'blue', 2)
    even_better_draw_circles(rg.Point(0, 50), 5, 9, 'blue', 2)
    even_better_draw_circles(rg.Point(0, -50), 5, 9, 'blue', 2)
    even_better_draw_circles(rg.Point(-50, 0), 5, 9, 'blue', 2)
...
def better_draw_circles(point, increase):
    """
...
def even_better_draw_circles(point, increase, number, color, thickness):
    turtle = rg.SimpleTurtle()
    ...
    for number in range(1, 11):  # k becomes 1, 2, 3, ... 10
        ...
        turtle.pen_down()
        turtle.draw_circle(increase * number)
